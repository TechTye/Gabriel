...
--
-- Host: 127.0.0.1
-- Generation Time: 25-Nov-2019 às 12:05
...
(2, 'ANDRÃ‰ SILVA', 'ANDRE@GMAIL.COM', 2, '123456789', 5),
(3, 'JHONATHAN VINICIUS', 'JHONATHAN@GMAIL.COM', 2, '123', 6),
(7, 'VICTOR RAIA', 'VICTOR.RAIA@GMAIL.COM', 2, '', 3),
(8, 'VICTOR MARTINS', 'KBRITO@GMAIL.COM', 2, '', 5);
...
(1, 'SKYFIT ACADEMIA BRASIL', 'SKYFIT@OUTLOOK.COM.BR', '(11) 3993-7447', '25.465.635/0001-2'),
...
CREATE TABLE `tb_contrato` (
  ...
  `cnt_dta_abertura` date NOT NULL,
  `cnt_dta_conclusao` date NOT NULL,
...
(1, 'SISTEMA WMS PERSONALIZADO', 'Criar um sistema personalizado para a SkyFit academias, sistema de gerenciador para a empresa', '2019-11-15', '2020-02-29', 'EM DESENVOLVIMENTO', '0', 2),
(2, 'SISTEMA TMS PERSONALIZADO', 'Criar um sistema TMS para a empresa Trans Passaredo', '2019-11-23', '2020-03-14', 'EM DESENVOLVIMENTO', '0', 2);
...
CREATE TABLE `tb_tarefa` (
  ...
  `taf_dta_conclusao` date NOT NULL,
...
(1, 'CRIAR LAYOUT WMS', 'Criar o layout grï¿½fico para o WMS da SkyFit', '2019-11-22', '0', 'EM ANÃLISE', 1, 1),
(2, 'CRIAR BANCO DE DADOS TMS', 'Desenvolver o Banco de Dados da Trans Passaredo, para uso do TMS da empresa', '2019-11-22', '0', 'EM DESENVOLVIMENTO', 2, 2);
...
--
ALTER TABLE `tb_administrador`
  MODIFY `adm_cod` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
